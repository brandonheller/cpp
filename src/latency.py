...
run_optimal_latencies(g, controllers, data, apsp)
...
run_greedy_informed(data, g, apsp)
...
# Greedy algorithms for computing node ordering that ignores the previous value
# Will be suboptional, but super-fast: only O(n) after computing the parameter
# values once.
run_greedy_alg(data, g, 'greedy-cc', 'latency', nx.closeness_centrality(g), apsp)
run_greedy_alg(data, g, 'greedy-dc', 'latency', nx.degree_centrality(g), apsp)
